#!/usr/bin/env bash
# StudioMeyer crew — Hook Recipe Installer
...
case "$MODE" in
  install)
    ...
    echo "(Type a prompt, Ctrl-D, watch for 'studiomeyer-crew: hook fired session...' in the statusline.)"
    ;;
