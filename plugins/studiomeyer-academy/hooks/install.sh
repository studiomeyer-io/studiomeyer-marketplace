#!/usr/bin/env bash
# StudioMeyer academy — Hook Recipe Installer
...
PLUGIN_NAME="studiomeyer-academy"
...
case "$MODE" in
  install)
    ...
    echo "(Type a prompt, Ctrl-D, watch for 'studiomeyer-academy: hook fired session...' in the statusline.)"
    ;;
